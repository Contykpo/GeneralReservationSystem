...
namespace GeneralReservationSystem.Web.Helpers
{
    ...
    public class PasswordHashingHelper<TUser> where TUser : class
    {
        /* =======================
        ...
        public PasswordHashingHelper(IOptions<PasswordHasherOptions>? optionsAccessor = null)
        {
        ...
        // Replace ArgumentNullThrowHelper.ThrowIfNull(...) with standard null checks and throw ArgumentNullException if needed
