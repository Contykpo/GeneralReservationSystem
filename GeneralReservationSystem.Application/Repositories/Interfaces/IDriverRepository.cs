...
namespace GeneralReservationSystem.Application.Repositories.Interfaces
{
    ...
    public interface IDriverRepository
    {
        ...
        Task<OptionalResult<IList<Driver>>> SearchPagedAsync(int pageIndex, int pageSize, string? firstName = null, // NOTE: Ideally, search should be in a service layer, but 
